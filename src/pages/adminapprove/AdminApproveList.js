...
function AdminApprove() {
  ...
  const returnForm = (e, userqNUM) => {
    ...
    e.preventDefault();
    axios({
      url: 'http://localhost:9191/admin/high/UserRequestReturn',
      method: 'post',
      data: {
        userq_NUM: userqNUM,
        username: username,
  ...
  const SearchForm = (inputText) => {
    // 검색 String boot로 전달
    axios({
      url: 'http://localhost:9191/admin/high/UserRequestSearch',
      method: 'post',
      data: {
        inputText: inputText,
      },
  ...
  useEffect(() => {
    ...
    if (inputInnerData.username === '' || inputInnerData.length === 0) {
      axios({
        url: 'http://localhost:9191/admin/high/UserRequestList',
        method: 'get',
        headers: {
          Authorization: token,
        },
          ...
          <div className="modal-content">
            ...
            <form action="#" name="ApproveForm">
              <div className="modal-body">
                ...
                />
                <input
                  className="assets_num"
                  type="hidden"
                  value={innerData.assets_num}
                />
              </div>
              <div className="modal-footer">
                ...
                <button
                  ...
                  onClick={(e) =>
                    ApproveForm(e, innerData.userqNUM, innerData.assets_num)
                  }
                >
                  승인
                </button>
