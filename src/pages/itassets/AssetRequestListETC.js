...
import AssetRequestListETCTable from './AssetRequestListETCTable';
...
const AssetRequestListETC = () => {
  ...
  const handleToggle = (e) => {
    ...
    setInnerDate({
      ...innerData,
      assets_name: e.target.closest('.prod-box').querySelector('.assets_name')
        .textContent,
      category_num: e.target.closest('.prod-box').querySelector('.category_num')
        .textContent,
  ...
  const AssetUsageRequestForm = async (e) => {
    ...
    try {
      const response = await axios.post(
        '/AssetRequest/AssetUsageRequest',
        innerData,
        {
          headers: {
            Authorization: token,
  ...
  const [innerBuyData, setInnerBuyDate] = useState({
    username: username || '',
    assets_name: '',
    userq_title: '',
    userq_comment: '',
      ...
      switch (sortType) {
        ...
        case 'war': {
          if (checkClass) {
            ...
            return a.etc_spec_warranty.localeCompare(b.etc_spec_warranty);
          }
        }
        case 'category': {
          if (checkClass) {
      ...
      >
        ...
        >
          <div className="card-body">
            ...
            <form
              method="post"
              name="AssetUsageRequestForm"
              onSubmit={(e) => AssetUsageRequestForm(e)}
            >
      ...
      >
        ...
        >
          <div className="card-body">
            ...
            <form
              method="post"
              name="AssetBuyRequestForm"
              onSubmit={(e) => AssetBuyRequestForm(e)}
            >
              <div className="modal-body">
                <div className="row mb-3 position-relative">
                  <label
...
export default AssetRequestListETC;
