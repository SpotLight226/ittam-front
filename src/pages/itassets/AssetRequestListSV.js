...
import AssetRequestListSVTable from './AssetRequestListSVTable';
      ...
      switch (sortType) {
        ...
        case 'war': {
          if (checkClass) {
            ...
            return a.server_spec_warranty.localeCompare(b.server_spec_warranty);
          }
        }
        case 'category': {
          if (checkClass) {
...
export default AssetRequestListSV;
